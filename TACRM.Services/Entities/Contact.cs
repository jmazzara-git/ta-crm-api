namespace TACRM.Services.Entities
{
	public class Contact
	{
		...
		public int? StatusID { get; set; } // Current status of the contact
		public string Name { get; set; } // Full name of the contact
		...
		public string KidsAges { get; set; } // JSON or CSV for ages
